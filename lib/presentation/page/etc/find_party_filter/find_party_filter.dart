...
class FindPartyFilter extends StatefulWidget {
  ...
  @override
  State<FindPartyFilter> createState() => _FindPartyFilterState();
}

class _FindPartyFilterState extends State<FindPartyFilter> {
