...
final findWorkFilterProvider =
    NotifierProvider.autoDispose<
      FindWorkFilterNotifier,
      ({List<String> current, List<List<String>> filter})
    >(FindWorkFilterNotifier.new);

class FindWorkFilter extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<FindWorkFilter> createState() => _FindWorkFilterState();
}

class _FindWorkFilterState extends ConsumerState<FindWorkFilter> {
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen(findWorkFilterProvider, (prev, next) {
      if (prev != null &&
  ...
  void onApplyFilterButtonPressed() {
    Navigator.pop(context, ref.read(findWorkFilterProvider).current);
  }
}
