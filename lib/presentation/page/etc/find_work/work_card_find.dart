...
import '../../future&component/layout/default_container.dart' show DefaultContainer;

class WorkCardFind extends StatelessWidget {
  final String name;
  final String? poster;
  final List<String> timePlace;
  final VoidCallback? onWorkInformationButtonPressed;
  ...
  const WorkCardFind({
    ...
    required this.onWorkInformationButtonPressed,
                    ...
                    Expanded(
                      ...
                      child: Container(
                        ...
                        child: TextButton(
                          ...
                          onPressed: onWorkInformationButtonPressed,
                          child: const Text(
                            '활동 정보',
