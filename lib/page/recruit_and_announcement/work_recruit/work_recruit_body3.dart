...
class WorkRecruitBody3 extends StatefulWidget {
  final ScrollController primaryScrollController;
  const WorkRecruitBody3({super.key, required this.primaryScrollController});

  @override
  State<WorkRecruitBody3> createState() => _WorkRecruitBody3State();
}

class _WorkRecruitBody3State extends State<WorkRecruitBody3> {
